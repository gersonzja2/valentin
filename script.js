...
if (loveBtn && hiddenMessage && bgMusic) {
    loveBtn.addEventListener('click', function() {
        // Mostrar el mensaje oculto con una transición suave
...
// Derivamos el mes y día del aniversario desde la fecha de inicio para no repetir
